    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-8 row-start-2 items-center text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl">
          A HUB created by Amdox that connects all your important data and uses
          automation to manage it easily on one secure system.
        </p>
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center text-sm text-gray-500 dark:text-gray-400">
        <p>&copy; {new Date().getFullYear()} Amdox. All rights reserved.</p>
      </footer>
    </div>
  );
}
